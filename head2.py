...
while cap.isOpened():
    ...
    if results.multi_face_landmarks:
        for face_landmarks in results.multi_face_landmarks:
            ...
            if typeC == 1:
                timerDetectTotal = timerDetectEnd - start
                cv2.putText(image, text, (20, 50), cv2.FONT_HERSHEY_SIMPLEX, 2, (0, 128, 255), 2)
                if timerDetectTotal > 5:
                    text = "Cheating"
        ...
        totalTime = end - start
        timerDetectTotal = timerDetectEnd - timerDetectStart

        fps = 1 / totalTime
        #print("FPS: ", fps)

        #cv2.putText(image, f'FPS: {int(fps)}', (20,450), cv2.FONT_HERSHEY_SIMPLEX, 1.5, (0,255,0), 2)
        #cv2.putText(image, "Time: " + str(timerDetectTotal), (20,450), cv2.FONT_HERSHEY_SIMPLEX, 1.5, (0,255,0), 2)
        cv2.putText(image, f'FPS: {int(timerDetectTotal)}', (20,450), cv2.FONT_HERSHEY_SIMPLEX, 1.5, (0,255,0), 2)
